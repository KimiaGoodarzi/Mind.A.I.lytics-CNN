# -*- coding: utf-8 -*-
"""Variant2ACOMP_472_Project_Part_2.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1HkrPPOkZC2G7A56dqYQNQXEmMI6E8vhN
"""
...
optimizer = optim.Adam(model_variant2A.parameters(), lr=learning_rate)
...
model_variant2A.to(device)

# Start training time
training_start_time = time.time()

for epoch in range(num_epochs):
    model_variant2A.train()
    ...
    for images, labels in train_loader:
        ...
        optimizer.zero_grad()
        outputs = model_variant2A(images)
    ...
    with torch.no_grad():
        ...
        for images, labels in val_loader:
            images, labels = images.to(device), labels.to(device)
            val_outputs = model_variant2A(images)
    ...
    if val_loss < best_val_loss:
        ...
        torch.save(model_variant2A.state_dict(), 'bestmodel_variant2A.pth')  # Save the best model
    else:
