# -*- coding: utf-8 -*-
"""variant1BCOMP_472_Project_Part_2.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1z1mz3Ys3bGmz0pwgKHVavZT99qgxrDcl
"""
...
model_variant1B.to(device)

# Start training time
training_start_time = time.time()

for epoch in range(num_epochs):
    model_variant1B.train()
    ...
    for images, labels in train_loader:
        ...
        optimizer.zero_grad()
        outputs = model_variant1B(images)
    ...
    with torch.no_grad():
        ...
        for images, labels in val_loader:
            images, labels = images.to(device), labels.to(device)
            val_outputs = model_variant1B(images)
    ...
    if val_loss < best_val_loss:
        ...
        torch.save(model_variant1B.state_dict(), 'bestmodel_variant1B.pth')  # Save the best model
    else:
